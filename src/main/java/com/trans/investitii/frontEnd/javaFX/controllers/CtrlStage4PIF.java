...
public class CtrlStage4PIF implements Initializable {
    ...
    public void initialize ( URL location, ResourceBundle resources ) {
        ...
        tabelFinalPif.setPlaceholder(new Label("Nici o factura de PIFUIT"));
        tabelFacturiPIF.setPlaceholder(new Label("Nici o factura de PIFUIT"));
    }
    ...
    public void validarePIF ( ActionEvent event ) throws SQLException {
        ...
        try {
            ...
            Alert alert0 = new Alert( Alert.AlertType.CONFIRMATION, "Confirmati PIF de "+total+"?", ButtonType.YES, ButtonType.NO);//, ButtonType.CANCEL);
            alert0.showAndWait();
